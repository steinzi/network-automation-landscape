...
`,lw=e=>y(iw,{get children(){return y(sw,{get children(){var t=aw();return z(t,y(ow,{get bgColor(){return e.bgColor},"aria-hidden":"true"})),t}})}});var uw=se("<div role=alert><div>");const cw=$`
  padding: 1.5rem;
  text-align: center;
  margin: 3rem auto;
...
`,mb=$`
  ...
  word-wrap: normal;
  max-height: 36px;
`,gb=e=>(()=>{var t=Xr();return j(t,tb),z(t,y(_t,{get href(){return`${mr()}?item=${e.item.id}`},class:rb,get children(){var r=Qw(),n=r.firstChild,a=n.firstChild,i=a.nextSibling,s=i.firstChild,o=s.nextSibling,l=o.nextSibling,u=n.nextSibling;return j(r,nb),j(n,ab),j(a,ib),z(a,y(xn,{get name(){return e.item.name},class:sb,get logo(){return e.item.logo}})),j(i,ob),j(s,lb),z(s,()=>e.item.name),j(o,ub),z(o,y(Q,{get when(){return e.item.organization_name},get children(){return e.item.organization_name}})),j(l,cb),z(l,y(Q,{get when(){return e.item.maturity},get fallback(){return y(Q,{get when(){return e.item.member_subcategory},get children(){var f=eb(),d=f.firstChild;return j(f,`${Jr} ${fb}`),z(f,()=>e.item.member_subcategory,d),ee(()=>fe(f,"title",`${e.item.member_subcategory} member`)),f}})},get children(){return[(()=>{var f=Xr();return j(f,`${Jr} ${hb}`),z(f,()=>e.foundation),ee(()=>fe(f,"title",e.item.maturity)),f})(),(()=>{var f=Xr();return j(f,`${Jr} ${db}`),z(f,()=>e.item.maturity),ee(()=>fe(f,"title",e.item.maturity)),f})()]}}),null),z(l,y(Q,{get when(){return e.item.website},get children(){return y(_t,{title:"Website",class:gi,get href(){return e.item.website},get children(){return y(mi,{get kind(){return Sn.World}})}})}}),null),z(l,y(Q,{get when(){return e.item.primary_repository_url},get children(){return y(_t,{title:"Repository",class:gi,get href(){return e.item.primary_repository_url},get children(){return y(mi,{get kind(){return Sn.GitHubCircle}})}})}}),null),j(u,mb),z(u,()=>e.item.description||"This item does not have a description available yet"),r}})),t})();var yb=se("<button>");const pb={[G.XSmall]:"0.25rem",[G.Small]:"0.35rem",[G.Medium]:"0.5rem",[G.Large]:"0.75rem",[G.XLarge]:"1rem"},_b=we("div")`
